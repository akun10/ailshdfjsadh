...
const char voice1[] PROGMEM = "khi";  //call the last skill data sent by the Skill Composer ## Will cause bug when skill is longer than 5 frames
#ifdef BITTLE
const char voice2[] PROGMEM = "kcmh";  //
#elif defined NYBBLE
const char voice2[] PROGMEM = "kcmh";  //
#endif
const char voice3[] PROGMEM = "krest";                          //动头 move head
const char voice4[] PROGMEM = "kjmp";                                  //moonwalk
const char voice5[] PROGMEM = "b14,8,14,8,21,8,21,8,23,8,23,8,21,4";  //小星星 twinkle star
const char voice6[] PROGMEM = "kshk";
const char voice7[] PROGMEM = "krest";
const char voice8[] PROGMEM = "kzero";
const char voice9[] PROGMEM = "khi";
const char voice10[] PROGMEM = "b1,1,1,1,1";
